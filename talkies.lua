...
function Talkies.draw()
  ...
  if Talkies.showIndicator then
    love.graphics.print(currentDialog.indicatorCharacter, boxX+boxW-(2.5*currentDialog.padding)-Talkies.font:getWidth(currentDialog.indicatorCharacter)+20, boxY+boxH-currentDialog.fontHeight-5)
  end
